export default {
  ...
  DOCS_URL: 'https://www.orpix.io.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.orpix.io.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.orpix.io.com/content.json',
